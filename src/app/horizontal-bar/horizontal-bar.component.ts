...
export class HorizontalBarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.barChart = echarts.init(<HTMLDivElement>document.getElementById('horizontal-bar-chart'));
    ...
    const options: EChartOption = {
      ...
      yAxis: {
        type: 'category', // horizontal bar
        // data phải đi kem với trục category
        data: ['x1', 'x2', 'x3', 'x4', 'x5'],
        axisLine: {
          lineStyle: {
            color: '#ccc',
    ...
    this.resizeObserver.observe(document.getElementById('horizontal-bar-chart-parent'));
    //
  }
  resizeObserver: any;
  ngOnDestroy(): void {
